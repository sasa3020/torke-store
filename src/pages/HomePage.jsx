        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 mt-1">
              مستلزمات تفوقك في الثانوية العامة
            </h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-10">
            <div>
              <span className="text-sky-400 text-xs font-extrabold uppercase tracking-wider flex items-center gap-1.5">
                <Zap size={15} />
                <span>أكواد المنصات التعليمية الرسمية</span>
              </span>
              <h2 className="text-2xl sm:text-3xl font-black text-white mt-1">
                اشحن رصيد منصات كبار المدرسين في دقائق
              </h2>
              <p className="text-xs sm:text-sm text-slate-400 mt-2 max-w-xl">
                لا داعي للانتظار في السنتر أو مشاكل الدفع الإلكتروني. اختر المدرس، أتمم طلبك، واستلم كود التفعيل الفوري مع الدعم الفني.
              </p>
            </div>
            <Link
              to="/products?category=Teacher%20Codes"
